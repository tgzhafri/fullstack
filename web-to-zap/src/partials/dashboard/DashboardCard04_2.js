...
function DashboardCard04_2() {
  ...
  // const pending = useSelector((state) => state.dashboard.pending.taskCount);
  // const completed = useSelector((state) => state.dashboard.complete.taskCount);

  // const pendingDates = pending.map((item) => item.day);
  // const completedDates = completed.map((item) => item.day);
  // console.log("pending??", pendingDates);
  // console.log("completed??", completedDates);
...
export default DashboardCard04_2;
