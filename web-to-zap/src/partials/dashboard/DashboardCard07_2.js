...
export default function DashboardCard0702() {
  const isLoading = useSelector((state) => state.categories.isLoading);
  const completed = useSelector((state) => state.categories.complete.taskCount);

  // console.log("pending?", pending);
  // console.log("completed", completed);

  // const completedCountArr = completed.map((item) => item.count);
  // const sum = completedCountArr.reduce((partial_sum, a) => partial_sum + a, 0);
